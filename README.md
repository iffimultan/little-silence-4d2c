...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/little-silence-4d2c)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/little-silence-4d2c
```

A live public deployment of this template is available at [https://little-silence-4d2c.templates.workers.dev](https://little-silence-4d2c.templates.workers.dev)
